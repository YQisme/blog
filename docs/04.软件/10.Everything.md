---
title: Everything
date: 2022-02-12 13:17:03
permalink: /pages/aa7af1/
categories:
  - 软件
tags:
  - 
...
可以，"Everything" 可以通过搜索函数 content: 来搜索文件内容。详见[使用Everything进行内容搜索 ](https://zhuanlan.zhihu.com/p/267193995)
...
### 如何搜索<font color='red'>指定位置的文件和文件夹</font>？

搜索指定位置的文件和文件夹，请在搜索框中使用 \。

例如，在 downloads 文件夹中搜索全部 mp3 文件：`downloads\ .mp3`:注意中间<font color='red'>有空格</font>
